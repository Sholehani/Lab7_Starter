...
async function getRecipes() {
  ...
  //            will be in the catch portion.
   try {
    ...
    const fetchVar = await fetch(RECIPE_URLS[i]);
    ...
    //            "await" again
    const recipeObj = await fetchVar.json();
    ...
    console.error("Error : getRecipes() function");
    // A11. TODO - Pass any errors to the Promise's reject() function
      reject("Something went wrong with fetching data.")
